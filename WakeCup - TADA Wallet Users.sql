select g.name "Name" , g.phone "Phone Number", g.email "Email Address", ci.no as "Card Number", cp."programName" "Program Name", date_trunc('day', g."createdAt") "Day"
  from "GCIUsers" g
